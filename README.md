About python-logging-rabbitmq-feedstock
=======================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/python-logging-rabbitmq-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11690&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/python-logging-rabbitmq-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `python-logging-rabbitmq` can be installed with `conda`:
...
```
mamba install python-logging-rabbitmq
```

It is possible to list all of the versions of `python-logging-rabbitmq` available on your platform with `conda`:
...
```
mamba search python-logging-rabbitmq --channel conda-forge
```
...
mamba repoquery search python-logging-rabbitmq --channel conda-forge

# List packages depending on `python-logging-rabbitmq`:
mamba repoquery whoneeds python-logging-rabbitmq --channel conda-forge

# List dependencies of `python-logging-rabbitmq`:
mamba repoquery depends python-logging-rabbitmq --channel conda-forge
```
